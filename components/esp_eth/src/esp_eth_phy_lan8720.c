...
/**
 * @brief TDR(Patterns/Delay Control Register)
 * Only available in LAN874xA
 */
typedef union {
    struct {
...
#define EHT_PHY_TDR_PATTERN_REG_ADDR (0x18)

/**
 * @brief TDR(Control/Status Register)
 * Only available in LAN874xA
 */
typedef union {
    struct {
...
#define EHT_PHY_TDR_CONTROL_REG_ADDR (0x19)
...
typedef union {
    struct {
        ...
        uint32_t enable_4b5b : 1;      /* Enable 4B5B encoder (only LAN8740A) */
